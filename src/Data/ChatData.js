...
export const chatsIniciales = [
    ...
    },
    {
        ...
        avatar: "https://unsplash.com/es/fotos/un-joven-con-gafas-parado-frente-a-una-montana-MSepzbKFz10",
        mensajes: [
    ...
    },
    {
        ...
        tipo: EMISOR.CONTACTO,
        avatar: "https://unsplash.com/es/fotos/una-joven-con-cabello-largo-con-una-camiseta-blanca-HaNi1rsZ6Nc",
        mensajes: [
    ...
    },
    {
        ...
        nombre: "Carlos Dev",
        tipo: EMISOR.CONTACTO,
        avatar: "https://unsplash.com/es/fotos/hombre-sonriente-de-pie-cerca-de-un-arbol-verde-MTZTGvDsHFY",
        mensajes: [
    ...
    },
    {
        ...
        tipo: EMISOR.CONTACTO,
        avatar: "https://unsplash.com/es/fotos/una-mujer-con-un-vestido-rosa-posando-para-una-foto-mynsNaNwVDc",
        mensajes: [
    ...
    {
        id: 9,
        nombre: "Jefe Nuevo Proyecto",
        tipo: EMISOR.CONTACTO,
        avatar: "https://unsplash.com/es/fotos/un-hombre-con-barba-y-gafas-de-pie-con-los-brazos-cruzados-9ZXpKFlQkjo",
        mensajes: [
    ...
    },
    {
        ...
        nombre: "Laura QA",
        tipo: EMISOR.CONTACTO,
        avatar: "https://unsplash.com/es/fotos/una-mujer-con-cabello-rizado-sonriendo-a-la-camara-NVRdBAwV2Qo",
        mensajes: [
...
export const contactosIniciales = [
    {
        ...
        avatar: "https://unsplash.com/es/fotos/hombre-con-camisa-blanca-de-cuello-redondo-con-gafas-de-sol-negras-Z4rqvRpRj38",
        tipo: EMISOR.CONTACTO 
    },
    { 
        id: "c2", 
        nombre: "Carla UX",
        avatar: "https://unsplash.com/es/fotos/mujer-sentada-sobre-hierba-verde-tTdC88_6a_I",
        tipo: EMISOR.CONTACTO 
    },
    { 
        id: "c3", 
        nombre: "Carlos Diseño",
        avatar: "https://unsplash.com/es/fotos/hombre-sonriente-de-pie-cerca-de-un-arbol-verde-MTZTGvDsHFY",
        tipo: EMISOR.CONTACTO 
    },
    {
        id: "c4", 
        nombre: "Flor Proyecto",
        avatar: "https://unsplash.com/es/fotos/mujer-con-camisa-floral-blanca-y-negra-2EdIX-O2lkI",
        tipo: EMISOR.CONTACTO 
    },
    { 
        id: "c5", 
        nombre: "Sofía Front-End", 
        avatar: "https://unsplash.com/es/fotos/una-mujer-con-un-vestido-rosa-posando-para-una-foto-mynsNaNwVDc",
        tipo: EMISOR.CONTACTO 
    },
    { 
